...
# Substitute: trick-taking, coworld-trick-taking, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-trick-taking:ci)
#   SMOKE_SLUG                 game slug                        (trick-taking)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/trick-taking)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/trick-taking-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-trick-taking:ci}}"
slug="${SMOKE_SLUG:-trick-taking}"
